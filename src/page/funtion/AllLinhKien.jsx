        ...
        {currentItems.map((product) => (
          <div key={product.id} className="product-card">
            <div className="product-image-container">
              <img
                src={(Array.isArray(product.images) && product.images[0]) || "https://example.com/placeholder.jpg"}
                alt={product.ten}
            ...
            <div className="product-details">
              ...
              <p className="product-compatible">
                Tương thích: {Array.isArray(product.thiet_bi_tuong_thich) ? product.thiet_bi_tuong_thich.join(", ") : (product.thiet_bi_tuong_thich || "Không có thông tin")}
              </p>
              {product.khuyen_mai && (
